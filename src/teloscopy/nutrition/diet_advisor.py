...
GEOGRAPHIC_FOOD_DB: list[GeographicProfile] = [
    ...
    # -- India: Kerala --
    GeographicProfile(
        region_id="india_kerala",
        name="Kerala, India",
        common_foods=["rice", "coconut curry", "appam", "puttu", "avial", "fish curry", "karimeen pollichathu", "sadya", "idiyappam", "parippu curry"],
        staple_grains=["rice", "rice flour", "tapioca"],
        protein_sources=["fish", "prawns", "chicken", "coconut", "lentils", "eggs", "duck"],
        vegetables=["drumstick", "ash gourd", "snake gourd", "yam", "banana", "bitter gourd", "moringa leaves", "jackfruit"],
        fruits=["coconut", "banana", "jackfruit", "mango", "pineapple", "papaya"],
        spices=["coconut oil", "curry leaves", "black pepper", "turmeric", "mustard seeds", "fenugreek", "cardamom", "star anise"],
        traditional_dishes=["Kerala fish curry", "avial", "karimeen pollichathu", "appam with stew", "puttu and kadala curry", "sadya (feast)", "erissery", "olan"],
    ),
    # -- India: Tamil Nadu --
    GeographicProfile(
        region_id="india_tamil_nadu",
        name="Tamil Nadu, India",
        common_foods=["rice", "idli", "dosa", "sambar", "rasam", "pongal", "chettinad chicken", "filter coffee", "kothu parotta", "vada"],
        staple_grains=["rice", "ragi (finger millet)", "rice flour", "urad dal"],
        protein_sources=["lentils", "chicken", "fish", "prawns", "eggs", "black gram", "crab"],
        vegetables=["drumstick", "brinjal", "lady finger", "banana stem", "bottle gourd", "moringa", "curry leaves"],
        fruits=["banana", "mango", "guava", "jackfruit", "wood apple", "custard apple"],
        spices=["curry leaves", "mustard seeds", "black pepper", "tamarind", "asafoetida", "fenugreek", "dried red chili", "sesame oil"],
        traditional_dishes=["Chettinad chicken", "idli-sambar", "dosa varieties", "pongal", "rasam", "kothu parotta", "fish kuzhambu", "payasam"],
    ),
    # -- India: Karnataka --
    GeographicProfile(
        region_id="india_karnataka",
        name="Karnataka, India",
        common_foods=["rice", "ragi mudde", "bisi bele bath", "dosa", "idli", "mysore pak", "jolada rotti", "uppittu", "vangibath", "chitranna"],
        staple_grains=["rice", "ragi (finger millet)", "jowar (sorghum)", "wheat"],
        protein_sources=["lentils", "chicken", "mutton", "fish", "black gram", "horsegram", "eggs"],
        vegetables=["ridge gourd", "ivy gourd", "drumstick", "brinjal", "banana flower", "raw banana", "bitter gourd"],
        fruits=["banana", "mango", "sapota", "guava", "jackfruit", "pomegranate"],
        spices=["curry leaves", "mustard seeds", "coconut", "jaggery", "tamarind", "byadagi chili", "asafoetida"],
        traditional_dishes=["bisi bele bath", "ragi mudde with saaru", "Mysore masala dosa", "jolada rotti with ennegai", "Dharwad peda", "Mangalorean fish curry"],
    ),
    # -- India: Andhra Pradesh --
    GeographicProfile(
        region_id="india_andhra",
        name="Andhra Pradesh, India",
        common_foods=["rice", "pesarattu", "gongura", "pulihora", "biryani", "gutti vankaya", "pappu", "avakaya", "tomato pappu", "royyala iguru"],
        staple_grains=["rice", "jowar (sorghum)", "green gram", "wheat"],
        protein_sources=["chicken", "mutton", "prawns", "fish", "lentils", "eggs", "crab"],
        vegetables=["gongura (sorrel)", "brinjal", "drumstick", "ridge gourd", "ivy gourd", "cluster beans", "raw banana"],
        fruits=["mango", "banana", "custard apple", "guava", "papaya", "tamarind"],
        spices=["red chili (guntur)", "tamarind", "mustard seeds", "curry leaves", "cumin", "fenugreek", "sesame oil", "asafoetida"],
        traditional_dishes=["Hyderabadi biryani", "pesarattu", "gongura mamsam", "gutti vankaya", "royyala iguru", "pulihora", "avakaya pickle"],
    ),
    # -- India: Maharashtra --
    GeographicProfile(
        region_id="india_maharashtra",
        name="Maharashtra, India",
        common_foods=["bhakri", "vada pav", "misal pav", "puran poli", "poha", "thalipeeth", "zunka bhakri", "sabudana khichdi", "pav bhaji", "modak"],
        staple_grains=["jowar (sorghum)", "bajra (pearl millet)", "rice", "wheat"],
        protein_sources=["lentils", "groundnuts", "chicken", "mutton", "fish", "eggs", "sprouted moth beans"],
        vegetables=["brinjal", "potato", "onion", "green leafy (methi)", "lady finger", "bottle gourd", "kothimbir (coriander)"],
        fruits=["alphonso mango", "banana", "guava", "custard apple", "kokum", "jamun"],
        spices=["kokum", "goda masala", "mustard seeds", "asafoetida", "turmeric", "red chili", "jaggery", "peanut oil"],
        traditional_dishes=["misal pav", "vada pav", "puran poli", "thalipeeth", "zunka bhakri", "modak", "pav bhaji", "Kolhapuri chicken"],
    ),
    # -- India: Gujarat --
    GeographicProfile(
        region_id="india_gujarat",
        name="Gujarat, India",
        common_foods=["dhokla", "thepla", "khandvi", "undhiyu", "dal-bhat-shaak-rotli", "fafda-jalebi", "handvo", "khakhra", "sev tameta", "basundi"],
        staple_grains=["wheat", "bajra (pearl millet)", "jowar (sorghum)", "rice", "chickpea flour"],
        protein_sources=["lentils", "mung bean", "chickpeas", "buttermilk", "yoghurt", "peanuts", "sesame"],
        vegetables=["bottle gourd", "ridge gourd", "cluster beans", "surti papdi", "potato", "raw banana", "yam"],
        fruits=["mango", "banana", "chikoo (sapota)", "jamun", "ber (jujube)", "pomegranate"],
        spices=["mustard seeds", "cumin", "asafoetida", "turmeric", "green chili", "jaggery", "sesame", "kokum"],
        traditional_dishes=["dhokla", "undhiyu", "khandvi", "thepla", "dal dhokli", "fafda-jalebi", "sev usal", "basundi"],
    ),
    # -- India: Rajasthan --
    GeographicProfile(
        region_id="india_rajasthan",
        name="Rajasthan, India",
        common_foods=["dal bati churma", "gatte ki sabzi", "ker sangri", "bajra roti", "laal maas", "ghevar", "papad ki sabzi", "pyaaz kachori"],
        staple_grains=["bajra (pearl millet)", "wheat", "jowar (sorghum)", "corn", "chickpea flour"],
        protein_sources=["lentils", "chickpeas", "buttermilk", "ghee", "yoghurt", "mutton", "dried beans"],
        vegetables=["ker (caper berry)", "sangri (desert beans)", "kumatiya", "raw banana", "potato", "dried vegetables"],
        fruits=["ber (jujube)", "pomegranate", "amla", "khejri beans", "raw mango"],
        spices=["red chili", "coriander", "cumin", "dried mango powder", "ghee", "asafoetida", "dried ginger"],
        traditional_dishes=["dal bati churma", "laal maas", "gatte ki sabzi", "ker sangri", "ghevar", "bajra roti with garlic chutney", "pyaaz kachori"],
    ),
    # -- India: Punjab --
    GeographicProfile(
        region_id="india_punjab",
        name="Punjab, India",
        common_foods=["makki ki roti", "sarson ka saag", "butter chicken", "dal makhani", "chole bhature", "lassi", "paratha", "paneer tikka", "tandoori chicken", "rajma"],
        staple_grains=["wheat", "corn (maize)", "basmati rice", "bajra (pearl millet)"],
        protein_sources=["chicken", "paneer", "lentils", "kidney beans", "mutton", "eggs", "yoghurt", "ghee"],
        vegetables=["mustard greens", "potato", "cauliflower", "spinach", "turnip", "radish", "fenugreek leaves"],
        fruits=["orange (kinnow)", "guava", "mango", "pomegranate", "amla"],
        spices=["garam masala", "cumin", "coriander", "turmeric", "red chili", "ghee", "dried fenugreek", "amchur"],
        traditional_dishes=["sarson ka saag-makki ki roti", "butter chicken", "dal makhani", "chole bhature", "tandoori chicken", "rajma chawal", "lassi"],
    ),
    # -- India: West Bengal --
    GeographicProfile(
        region_id="india_west_bengal",
        name="West Bengal, India",
        common_foods=["rice", "ilish (hilsa)", "shorshe maach", "kosha mangsho", "luchi-alur dom", "mishti doi", "rasgulla", "posto (poppy seed)", "begun bhaja", "chingri malaikari"],
        staple_grains=["rice", "rice flour", "wheat (maida)"],
        protein_sources=["hilsa fish", "rohu fish", "prawns", "chicken", "mutton", "lentils (masoor)", "eggs", "poppy seeds"],
        vegetables=["potato", "pumpkin", "brinjal", "pointed gourd", "banana flower", "raw banana", "radish", "kohlrabi"],
        fruits=["mango (langra)", "lychee", "jackfruit", "banana", "guava", "coconut"],
        spices=["mustard oil", "panch phoron", "mustard seeds", "turmeric", "green chili", "nigella seeds", "poppy seeds"],
        traditional_dishes=["ilish bhapa", "kosha mangsho", "chingri malaikari", "luchi-alur dom", "shukto", "mishti doi", "rasgulla", "sandesh"],
    ),
    # -- India: Uttar Pradesh --
    GeographicProfile(
        region_id="india_uttar_pradesh",
        name="Uttar Pradesh, India",
        common_foods=["roti", "dal", "aloo sabzi", "biryani", "kebab", "chaat", "petha", "bedmi puri", "kachori", "tehri"],
        staple_grains=["wheat", "rice", "barley", "chickpea flour"],
        protein_sources=["lentils (arhar, chana)", "chicken", "mutton", "paneer", "milk", "yoghurt", "eggs"],
        vegetables=["potato", "cauliflower", "spinach", "peas", "okra", "bottle gourd", "pumpkin", "turnip"],
        fruits=["mango (dasheri)", "guava", "banana", "amla", "watermelon", "litchi"],
        spices=["cumin", "coriander", "turmeric", "red chili", "garam masala", "asafoetida", "mustard oil", "ghee"],
        traditional_dishes=["Lucknowi biryani", "galawati kebab", "bedmi puri-aloo", "chaat varieties", "petha", "banarasi paan", "tehri"],
    ),
    # -- India: Goa --
    GeographicProfile(
        region_id="india_goa",
        name="Goa, India",
        common_foods=["fish curry rice", "vindaloo", "xacuti", "bebinca", "ros omelette", "pork sorpotel", "feni", "prawn balchão", "sannas"],
        staple_grains=["rice", "rice flour", "wheat (pao/bread)"],
        protein_sources=["fish (kingfish, pomfret)", "prawns", "pork", "chicken", "clams", "crab", "beef", "eggs"],
        vegetables=["kokum", "raw mango", "drumstick", "brinjal", "lady finger", "breadfruit", "colocasia"],
        fruits=["coconut", "cashew fruit", "mango", "jackfruit", "pineapple", "papaya"],
        spices=["coconut", "kokum", "tamarind", "red chili (kashmiri)", "vinegar", "cinnamon", "clove", "toddy vinegar"],
        traditional_dishes=["fish curry rice", "pork vindaloo", "chicken xacuti", "bebinca", "prawn balchão", "sorpotel", "sannas", "feni"],
    ),
    # -- India: Odisha --
    GeographicProfile(
        region_id="india_odisha",
        name="Odisha, India",
        common_foods=["pakhala bhata", "dalma", "chhena poda", "machha besara", "santula", "rasgulla", "mudhi mansa", "kanika", "enduri pitha"],
        staple_grains=["rice", "ragi (finger millet)", "rice flour"],
        protein_sources=["fish", "prawns", "crab", "chicken", "lentils", "paneer (chhena)", "mustard paste", "eggs"],
        vegetables=["raw banana", "pumpkin", "drumstick", "papaya (raw)", "brinjal", "potato", "pointed gourd", "colocasia"],
        fruits=["mango", "banana", "coconut", "jackfruit", "black plum"],
        spices=["mustard", "panch phoron", "turmeric", "cumin", "dried red chili", "mustard oil", "curry leaves"],
        traditional_dishes=["pakhala bhata", "dalma", "chhena poda", "machha besara", "santula", "enduri pitha", "mudhi mansa", "chenna jhili"],
    ),
    # ======================== CHINESE REGIONAL ============================
    # -- China: Sichuan --
    GeographicProfile(
        region_id="china_sichuan",
        name="Sichuan, China",
        common_foods=["rice", "mapo tofu", "kung pao chicken", "dan dan noodles", "hot pot", "twice-cooked pork", "sichuan pickles", "doubanjiang"],
        staple_grains=["rice", "wheat noodles", "rice noodles"],
        protein_sources=["pork", "tofu", "chicken", "fish", "beef", "duck", "eggs", "silkworm"],
        vegetables=["chinese cabbage", "water spinach", "bamboo shoots", "lotus root", "chili peppers", "garlic stems", "bean sprouts"],
        fruits=["orange", "tangerine", "loquat", "pomelo", "kiwi"],
        spices=["sichuan peppercorn", "dried chili", "doubanjiang", "ginger", "garlic", "star anise", "fermented black beans"],
        traditional_dishes=["mapo tofu", "kung pao chicken", "dan dan noodles", "sichuan hot pot", "twice-cooked pork", "fish-fragrant eggplant", "water-boiled fish"],
    ),
    # -- China: Cantonese (Guangdong) --
    GeographicProfile(
        region_id="china_cantonese",
        name="Cantonese (Guangdong), China",
        common_foods=["dim sum", "congee", "char siu", "wonton noodles", "steamed fish", "clay pot rice", "lo mai gai", "cheung fun"],
        staple_grains=["rice", "rice noodles", "wheat noodles"],
        protein_sources=["pork", "chicken", "duck", "fish", "shrimp", "tofu", "beef", "eggs", "oyster"],
        vegetables=["choy sum", "gai lan (Chinese broccoli)", "water spinach", "winter melon", "lotus root", "bean sprouts", "chinese mushroom"],
        fruits=["lychee", "longan", "starfruit", "papaya", "pomelo", "banana"],
        spices=["ginger", "scallion", "oyster sauce", "soy sauce", "sesame oil", "five-spice powder", "white pepper"],
        traditional_dishes=["dim sum", "char siu (BBQ pork)", "steamed whole fish", "wonton noodles", "congee", "clay pot rice", "white cut chicken"],
    ),
    # -- China: Shandong (Lu) --
    GeographicProfile(
        region_id="china_shandong",
        name="Shandong, China",
        common_foods=["steamed buns (mantou)", "braised sea cucumber", "sweet-sour carp", "jiaozi", "scallion pancakes", "braised pork knuckle", "corn porridge"],
        staple_grains=["wheat", "corn", "millet", "rice"],
        protein_sources=["sea cucumber", "fish", "pork", "chicken", "shrimp", "eggs", "clam", "squid"],
        vegetables=["chinese cabbage", "scallion", "garlic", "potato", "celery", "leek", "radish"],
        fruits=["apple (Yantai)", "pear", "cherry", "grape", "date (jujube)", "peach"],
        spices=["scallion", "ginger", "garlic", "soy sauce", "vinegar", "star anise", "cinnamon"],
        traditional_dishes=["sweet and sour Yellow River carp", "braised sea cucumber", "dezhou braised chicken", "jiaozi (dumplings)", "Shandong mantou"],
    ),
    # -- China: Jiangsu/Shanghai (Huaiyang) --
    GeographicProfile(
        region_id="china_jiangsu",
        name="Jiangsu/Shanghai, China",
        common_foods=["xiaolongbao", "sweet-braised pork belly", "lion's head meatballs", "hairy crab", "scallion oil noodles", "salted duck", "eight-treasure rice"],
        staple_grains=["rice", "wheat noodles", "glutinous rice"],
        protein_sources=["pork", "freshwater fish", "crab", "shrimp", "duck", "chicken", "tofu", "eel"],
        vegetables=["bamboo shoots", "water chestnut", "lotus root", "bok choy", "edamame", "taro", "shepherd's purse"],
        fruits=["bayberry (yangmei)", "loquat", "peach", "watermelon", "plum", "orange"],
        spices=["soy sauce (light)", "rice wine (Shaoxing)", "sugar", "ginger", "scallion", "vinegar", "sesame oil"],
        traditional_dishes=["xiaolongbao", "red-braised pork belly", "lion's head meatballs", "Nanjing salted duck", "beggar's chicken", "sweet and sour mandarin fish"],
    ),
    # -- China: Hunan (Xiang) --
    GeographicProfile(
        region_id="china_hunan",
        name="Hunan, China",
        common_foods=["rice", "smoked pork", "steamed fish head", "stinky tofu", "rice noodles (changsha)", "mao's braised pork", "pickled chili", "lotus seed soup"],
        staple_grains=["rice", "rice noodles", "wheat noodles"],
        protein_sources=["pork", "fish", "chicken", "duck", "tofu", "eggs", "frog", "beef"],
        vegetables=["lotus root", "winter bamboo shoots", "chili pepper", "garlic bolt", "water spinach", "wood ear mushroom", "pickled greens"],
        fruits=["orange", "tangerine", "pomelo", "kiwi", "chestnut"],
        spices=["fresh chili", "pickled chili", "fermented black beans", "garlic", "shallot", "ginger", "cassia bark"],
        traditional_dishes=["Chairman Mao's braised pork", "steamed fish head with chopped chili", "Changsha stinky tofu", "Hunan smoked pork", "dong'an chicken"],
    ),
    # ======================== US REGIONS ==================================
    # -- USA: Southern States --
    GeographicProfile(
        region_id="usa_south",
        name="US Southern States",
        common_foods=["fried chicken", "collard greens", "grits", "cornbread", "biscuits and gravy", "barbecue", "gumbo", "catfish", "sweet tea", "pecan pie"],
        staple_grains=["corn (grits, cornbread)", "wheat (biscuits)", "rice"],
        protein_sources=["chicken", "pork (BBQ)", "catfish", "shrimp", "crawfish", "turkey", "black-eyed peas", "eggs"],
        vegetables=["collard greens", "okra", "sweet potato", "tomato", "green beans", "squash", "turnip greens"],
        fruits=["peach", "pecan", "watermelon", "blackberry", "muscadine grape", "fig"],
        spices=["cayenne pepper", "paprika", "garlic", "onion", "bay leaf", "thyme", "hot sauce", "liquid smoke"],
        traditional_dishes=["fried chicken", "shrimp and grits", "gumbo", "jambalaya", "pulled pork BBQ", "biscuits and gravy", "pecan pie", "collard greens with ham hock"],
    ),
    # -- USA: Northeast --
    GeographicProfile(
        region_id="usa_northeast",
        name="US Northeast",
        common_foods=["clam chowder", "lobster roll", "bagel", "pizza", "cheesesteak", "maple syrup", "apple cider", "pastrami sandwich"],
        staple_grains=["wheat (bread, bagels, pasta)", "rye", "oats"],
        protein_sources=["lobster", "clam", "cod", "scallop", "beef", "chicken", "eggs", "crab"],
        vegetables=["potato", "corn", "squash", "kale", "cranberry", "pumpkin", "carrot"],
        fruits=["apple", "blueberry", "cranberry", "strawberry", "grape (Concord)", "pear"],
        spices=["black pepper", "oregano", "basil", "garlic", "maple syrup", "horseradish", "celery seed"],
        traditional_dishes=["New England clam chowder", "lobster roll", "New York pizza", "Philly cheesesteak", "Boston baked beans", "bagel with lox"],
    ),
    # -- USA: Midwest --
    GeographicProfile(
        region_id="usa_midwest",
        name="US Midwest",
        common_foods=["casserole (hotdish)", "bratwurst", "deep-dish pizza", "walleye", "cheese curds", "corn on the cob", "wild rice", "pot roast"],
        staple_grains=["wheat", "corn", "wild rice", "oats", "barley"],
        protein_sources=["beef", "pork", "walleye", "perch", "chicken", "turkey", "venison", "cheese", "eggs"],
        vegetables=["corn", "potato", "green bean", "cabbage", "carrot", "beet", "squash"],
        fruits=["apple", "cherry (Door County)", "blueberry", "strawberry", "rhubarb", "grape"],
        spices=["black pepper", "dill", "caraway", "mustard", "garlic", "onion powder", "paprika"],
        traditional_dishes=["Minnesota hotdish", "Chicago deep-dish pizza", "bratwurst", "cheese curds", "Cincinnati chili", "wild rice soup", "pot roast"],
    ),
    # -- USA: West Coast --
    GeographicProfile(
        region_id="usa_west",
        name="US West Coast",
        common_foods=["avocado toast", "sushi", "sourdough bread", "wild salmon", "acai bowl", "fish tacos", "farm-to-table salads", "cioppino"],
        staple_grains=["wheat (sourdough)", "rice", "quinoa", "oats"],
        protein_sources=["wild salmon", "tuna", "chicken", "tofu", "black beans", "almonds", "eggs", "dungeness crab"],
        vegetables=["avocado", "kale", "artichoke", "meyer lemon", "heirloom tomato", "sprouts", "seaweed"],
        fruits=["avocado", "strawberry", "orange", "date", "fig", "olive", "pomegranate", "meyer lemon"],
        spices=["garlic", "cilantro", "lime", "chili flake", "sriracha", "soy sauce", "smoked salt"],
        traditional_dishes=["cioppino", "fish tacos", "California roll", "sourdough bread bowl", "In-N-Out burger", "acai bowl", "Dungeness crab"],
    ),
    # -- USA: Southwest --
    GeographicProfile(
        region_id="usa_southwest",
        name="US Southwest",
        common_foods=["green chile", "enchiladas", "tamales", "pinto beans", "carne asada", "sopapilla", "posole", "Navajo fry bread", "chile relleno"],
        staple_grains=["corn (tortilla)", "wheat (flour tortilla)", "pinto beans"],
        protein_sources=["beef", "pork", "chicken", "pinto beans", "black beans", "cheese", "eggs", "bison"],
        vegetables=["green chile (Hatch)", "jalapeño", "squash", "tomato", "corn", "nopal (cactus)", "onion", "jicama"],
        fruits=["prickly pear", "date", "pecan", "fig", "pomegranate", "lime", "melon"],
        spices=["green chile", "red chile", "cumin", "oregano (Mexican)", "garlic", "cilantro", "chipotle", "epazote"],
        traditional_dishes=["green chile stew", "enchiladas", "tamales", "carne asada", "posole", "chile relleno", "sopapilla", "Navajo fry bread"],
    ),
    # ======================== JAPANESE REGIONAL ============================
    # -- Japan: Okinawa (Blue Zone) --
    GeographicProfile(
        region_id="japan_okinawa",
        name="Okinawa, Japan (Blue Zone)",
        common_foods=["beni-imo (purple sweet potato)", "goya chanpuru", "tofu", "mozuku seaweed", "soba (Okinawan)", "shikuwasa", "awamori", "rafute"],
        staple_grains=["rice", "sweet potato (beni-imo)", "soba noodles"],
        protein_sources=["tofu", "pork (sparingly)", "fish", "seaweed", "miso", "soy", "eggs"],
        vegetables=["goya (bitter melon)", "purple sweet potato", "daikon", "shikuwasa", "seaweed (mozuku, kombu)", "loofah", "green papaya"],
        fruits=["shikuwasa (citrus)", "pineapple", "mango", "dragon fruit", "papaya", "passion fruit"],
        spices=["turmeric (ukkon)", "ginger", "miso", "soy sauce", "dashi", "shikuwasa juice", "brown sugar"],
        traditional_dishes=["goya chanpuru", "rafute (braised pork belly)", "Okinawan soba", "taco rice", "jimami tofu", "mozuku vinegar", "beni-imo tart"],
    ),
    # ======================== LATIN AMERICA ================================
    # -- Mexico: Central --
    GeographicProfile(
        region_id="mexico_central",
        name="Central Mexico",
        common_foods=["tacos", "tamales", "mole", "pozole", "enchiladas", "tlacoyos", "quesadillas", "atole", "chilaquiles", "huitlacoche"],
        staple_grains=["corn (nixtamalized)", "wheat (bolillo)", "amaranth", "rice"],
        protein_sources=["beans (black, pinto)", "chicken", "pork", "beef", "cheese", "eggs", "chapulines (grasshoppers)", "turkey"],
        vegetables=["nopal (cactus)", "squash", "chayote", "tomato", "tomatillo", "avocado", "poblano chile", "huitlacoche"],
        fruits=["guava", "prickly pear (tuna)", "mamey", "zapote", "lime", "papaya", "mango", "tamarind"],
        spices=["dried chile (ancho, pasilla, guajillo)", "epazote", "cumin", "oregano", "cinnamon", "achiote", "chocolate", "vanilla"],
        traditional_dishes=["mole poblano", "tacos al pastor", "chiles en nogada", "pozole", "tamales", "tlacoyos", "atole", "chilaquiles"],
    ),
    # -- Brazil: Northeast --
    GeographicProfile(
        region_id="brazil_northeast",
        name="Northeast Brazil",
        common_foods=["acarajé", "vatapá", "moqueca", "tapioca crepe", "carne de sol", "baião de dois", "feijão tropeiro", "cuscuz (couscous)"],
        staple_grains=["cassava (farinha)", "rice", "corn", "tapioca"],
        protein_sources=["black beans", "dried beef (carne de sol)", "shrimp", "fish", "chicken", "goat", "eggs"],
        vegetables=["okra", "pumpkin", "maxixe", "palm heart", "sweet potato", "tomato", "onion"],
        fruits=["cashew fruit", "mango", "passion fruit", "coconut", "jackfruit", "acerola", "guava", "cajá"],
        spices=["dendê (palm oil)", "coconut milk", "coriander", "lime", "malagueta pepper", "cumin", "annatto"],
        traditional_dishes=["acarajé", "vatapá", "moqueca baiana", "carne de sol with macaxeira", "baião de dois", "tapioca crepe", "caruru"],
    ),
    # -- Brazil: Southeast --
    GeographicProfile(
        region_id="brazil_southeast",
        name="Southeast Brazil",
        common_foods=["feijoada", "pão de queijo", "coxinha", "picanha", "brigadeiro", "pastel", "açaí bowl", "mortadela sandwich"],
        staple_grains=["rice", "wheat (bread)", "cassava flour (farofa)", "corn"],
        protein_sources=["black beans", "beef (picanha)", "chicken", "pork", "fish", "eggs", "cheese (Minas)"],
        vegetables=["kale (couve)", "tomato", "okra", "chayote", "corn", "cassava", "heart of palm"],
        fruits=["orange", "banana", "acai", "guava", "passion fruit", "jabuticaba", "persimmon"],
        spices=["garlic", "bay leaf", "cumin", "parsley", "scallion", "black pepper", "cachaca"],
        traditional_dishes=["feijoada", "pão de queijo", "picanha na brasa", "tutu de feijão", "coxinha", "virado à paulista", "moqueca capixaba"],
    ),
    # ======================== ITALIAN REGIONAL =============================
    # -- Italy: Southern (Mezzogiorno) --
    GeographicProfile(
        region_id="italy_south",
        name="Southern Italy",
        common_foods=["pasta (orecchiette, paccheri)", "pizza napoletana", "mozzarella di bufala", "seafood", "eggplant parmigiana", "limoncello", "sfogliatella"],
        staple_grains=["durum wheat (pasta)", "semolina", "wheat (bread)", "farro"],
        protein_sources=["fish (swordfish, anchovies)", "mussels", "clams", "buffalo mozzarella", "beans", "eggs", "pork", "lamb"],
        vegetables=["eggplant", "tomato (San Marzano)", "zucchini", "artichoke", "broccoli rabe", "pepper", "olive"],
        fruits=["lemon (Amalfi)", "orange (blood)", "fig", "grape", "pomegranate", "prickly pear", "melon"],
        spices=["basil", "oregano", "garlic", "red pepper flakes", "olive oil (extra virgin)", "capers", "anchovies"],
        traditional_dishes=["pizza napoletana", "pasta alla Norma", "spaghetti alle vongole", "eggplant parmigiana", "orecchiette con cime di rapa", "sfogliatella"],
    ),
    # -- Italy: Northern --
    GeographicProfile(
        region_id="italy_north",
        name="Northern Italy",
        common_foods=["risotto", "polenta", "tortellini", "ossobuco", "focaccia", "pesto", "tiramisu", "cotoletta alla milanese"],
        staple_grains=["rice (Arborio, Carnaroli)", "corn (polenta)", "wheat (egg pasta)", "buckwheat (pizzoccheri)"],
        protein_sources=["beef", "veal", "pork (prosciutto, pancetta)", "fish (lake)", "parmigiano-reggiano", "eggs", "gorgonzola"],
        vegetables=["pumpkin", "radicchio", "asparagus", "truffle", "mushroom (porcini)", "artichoke", "spinach"],
        fruits=["apple (Alto Adige)", "pear", "chestnut", "grape", "cherry", "peach", "hazelnut"],
        spices=["saffron (Milan)", "rosemary", "sage", "nutmeg", "white truffle", "butter", "balsamic vinegar"],
        traditional_dishes=["risotto alla milanese", "tortellini in brodo", "ossobuco", "polenta taragna", "pesto alla genovese", "tiramisu", "bollito misto"],
    ),
]
...
FOOD_DATABASE: list[FoodItem] = [
    ...
    # ==================================================================
    # NEW REGION-SPECIFIC FOODS  (≥150 entries)
    # ==================================================================
    # ====================== KERALA, INDIA =============================
    _fi("karimeen (pearl spot fish)", 96, 19.0, 0.0, 1.8, 0.0, {"selenium": 36.5, "omega_3": 220.0, "phosphorus": 217.0}, "fish", ["india_kerala", "south_asia_south"]),
    _fi("coconut oil", 862, 0.0, 0.0, 100.0, 0.0, {"vitamin_e": 0.09}, "oil", ["india_kerala", "south_asia_south", "southeast_asia"]),
    _fi("tapioca (cassava)", 160, 1.4, 38.1, 0.3, 1.8, {"vitamin_c": 20.6, "manganese": 0.38, "potassium": 271.0}, "grain", ["india_kerala", "south_asia_south", "sub_saharan_africa", "southeast_asia"]),
    _fi("appam (rice pancake)", 180, 3.5, 32.0, 4.0, 0.8, {"iron": 0.8, "calcium": 12.0}, "prepared", ["india_kerala", "south_asia_south"]),
    _fi("puttu (steamed rice cake)", 210, 3.8, 38.0, 4.5, 1.2, {"iron": 1.0, "calcium": 18.0, "thiamine": 0.05}, "prepared", ["india_kerala", "south_asia_south"]),
    _fi("avial (mixed vegetable curry)", 98, 2.5, 8.0, 6.5, 2.8, {"vitamin_c": 15.0, "potassium": 230.0, "vitamin_a": 120.0}, "prepared", ["india_kerala", "south_asia_south"]),
    _fi("parippu curry (dal)", 116, 7.8, 16.5, 2.2, 3.8, {"iron": 2.5, "folate": 0.12, "zinc": 1.4}, "legume", ["india_kerala", "south_asia_south"]),
    _fi("idiyappam (string hoppers)", 150, 2.5, 32.0, 0.5, 0.6, {"iron": 0.5, "calcium": 8.0}, "prepared", ["india_kerala", "india_tamil_nadu", "south_asia_south"]),
    _fi("matta rice (Kerala red rice)", 346, 7.0, 76.0, 1.0, 2.2, {"iron": 1.2, "magnesium": 52.0, "zinc": 1.4, "manganese": 1.1}, "grain", ["india_kerala", "south_asia_south"]),
    _fi("drumstick (moringa pods)", 37, 2.1, 8.5, 0.2, 3.2, {"vitamin_c": 141.0, "calcium": 30.0, "potassium": 461.0, "iron": 0.4}, "vegetable", ["india_kerala", "india_tamil_nadu", "india_karnataka", "india_andhra", "south_asia_south"]),
    # ====================== TAMIL NADU, INDIA =========================
    _fi("ragi (finger millet)", 328, 7.3, 72.0, 1.3, 11.5, {"calcium": 344.0, "iron": 3.9, "phosphorus": 283.0}, "grain", ["india_tamil_nadu", "india_karnataka", "south_asia_south"]),
    _fi("filter coffee (South Indian)", 2, 0.1, 0.3, 0.0, 0.0, {"caffeine": 60.0, "polyphenols": 200.0}, "beverage", ["india_tamil_nadu", "india_karnataka", "south_asia_south"]),
    _fi("kothu parotta", 315, 8.5, 36.0, 15.0, 1.5, {"iron": 2.0, "sodium": 480.0, "calcium": 25.0}, "prepared", ["india_tamil_nadu", "south_asia_south"]),
    _fi("rasam", 22, 1.0, 3.5, 0.5, 0.4, {"vitamin_c": 12.0, "iron": 0.6, "potassium": 95.0}, "prepared", ["india_tamil_nadu", "india_karnataka", "india_andhra", "south_asia_south"]),
    _fi("pongal (ven pongal)", 142, 4.0, 22.0, 4.5, 1.2, {"iron": 1.2, "calcium": 18.0, "phosphorus": 85.0}, "prepared", ["india_tamil_nadu", "south_asia_south"]),
    _fi("murukku (chakli)", 480, 8.0, 54.0, 26.0, 2.0, {"iron": 2.5, "sodium": 620.0}, "snack", ["india_tamil_nadu", "india_karnataka", "south_asia_south"]),
    _fi("chettinad chicken curry", 162, 18.0, 4.0, 8.5, 1.0, {"iron": 1.8, "zinc": 2.4, "selenium": 18.0}, "prepared", ["india_tamil_nadu", "south_asia_south"]),
    _fi("kozhukattai (modak)", 175, 3.0, 30.0, 5.0, 1.0, {"iron": 0.8, "calcium": 22.0}, "snack", ["india_tamil_nadu", "india_karnataka", "south_asia_south"]),
    _fi("banana stem (vazhaithandu)", 20, 0.5, 4.0, 0.1, 1.5, {"potassium": 280.0, "vitamin_b6": 0.36, "iron": 0.3}, "vegetable", ["india_tamil_nadu", "india_kerala", "south_asia_south"]),
    # ====================== KARNATAKA, INDIA ==========================
    _fi("ragi mudde (finger millet ball)", 106, 2.6, 22.0, 0.5, 3.5, {"calcium": 120.0, "iron": 1.4, "phosphorus": 96.0}, "prepared", ["india_karnataka", "south_asia_south"]),
    _fi("bisi bele bath", 148, 5.0, 22.0, 4.2, 2.0, {"iron": 1.5, "calcium": 28.0, "zinc": 1.0, "folate": 0.04}, "prepared", ["india_karnataka", "south_asia_south"]),
    _fi("jolada rotti (sorghum flatbread)", 334, 10.4, 72.1, 3.3, 6.7, {"iron": 4.4, "phosphorus": 274.0, "magnesium": 171.0}, "grain", ["india_karnataka", "india_maharashtra", "south_asia_south", "south_asia_west"]),
    _fi("mysore pak", 450, 5.5, 32.0, 34.0, 0.5, {"calcium": 15.0, "iron": 1.0}, "snack", ["india_karnataka", "south_asia_south"]),
    _fi("akki rotti (rice flour roti)", 220, 3.5, 40.0, 5.0, 1.5, {"iron": 0.8, "calcium": 10.0}, "prepared", ["india_karnataka", "south_asia_south"]),
    # ====================== ANDHRA PRADESH, INDIA =====================
    _fi("pesarattu (green gram crepe)", 105, 6.8, 14.5, 2.0, 2.5, {"iron": 1.8, "folate": 0.08, "zinc": 1.0}, "prepared", ["india_andhra", "south_asia_south"]),
    _fi("gongura (sorrel leaves)", 26, 1.7, 3.8, 0.7, 1.1, {"vitamin_c": 62.0, "iron": 4.0, "calcium": 90.0, "vitamin_a": 140.0}, "vegetable", ["india_andhra", "south_asia_south"]),
    _fi("gutti vankaya (stuffed eggplant)", 92, 2.0, 8.0, 6.0, 2.5, {"iron": 1.0, "potassium": 180.0, "vitamin_c": 5.0}, "prepared", ["india_andhra", "south_asia_south"]),
    _fi("royyala iguru (prawn curry)", 145, 18.0, 3.5, 6.5, 0.5, {"selenium": 28.0, "zinc": 1.8, "omega_3": 350.0}, "prepared", ["india_andhra", "south_asia_south"]),
    _fi("pulihora (tamarind rice)", 175, 3.0, 32.0, 4.0, 1.0, {"iron": 1.0, "vitamin_c": 4.0, "potassium": 120.0}, "prepared", ["india_andhra", "south_asia_south"]),
    _fi("guntur red chili", 318, 12.0, 56.0, 17.0, 28.0, {"vitamin_c": 144.0, "vitamin_a": 530.0, "iron": 7.8, "capsaicin": 3.5}, "spice", ["india_andhra", "south_asia_south"]),
    # ====================== MAHARASHTRA, INDIA ========================
    _fi("vada pav", 290, 6.0, 34.0, 14.0, 1.5, {"iron": 1.8, "sodium": 520.0, "potassium": 180.0}, "prepared", ["india_maharashtra", "south_asia_west"]),
    _fi("misal pav", 250, 8.0, 32.0, 10.0, 3.0, {"iron": 2.5, "calcium": 35.0, "folate": 0.06}, "prepared", ["india_maharashtra", "south_asia_west"]),
    _fi("puran poli", 280, 6.0, 45.0, 8.5, 2.0, {"iron": 1.5, "calcium": 20.0, "zinc": 0.8}, "prepared", ["india_maharashtra", "south_asia_west"]),
    _fi("thalipeeth (multi-grain flatbread)", 220, 6.5, 32.0, 7.5, 3.0, {"iron": 2.0, "calcium": 30.0, "magnesium": 45.0, "phosphorus": 120.0}, "prepared", ["india_maharashtra", "south_asia_west"]),
    _fi("poha (flattened rice)", 130, 2.5, 26.0, 1.5, 0.5, {"iron": 8.0, "zinc": 0.6, "thiamine": 0.08}, "grain", ["india_maharashtra", "india_gujarat", "south_asia_west"]),
    _fi("sabudana khichdi (tapioca pearl)", 180, 2.0, 38.0, 3.0, 0.5, {"iron": 0.5, "potassium": 120.0, "calcium": 15.0}, "prepared", ["india_maharashtra", "south_asia_west"]),
    _fi("kokum (Garcinia indica)", 60, 0.5, 14.5, 0.1, 1.0, {"vitamin_c": 15.0, "hydroxycitric_acid": 120.0, "anthocyanins": 80.0}, "fruit", ["india_maharashtra", "india_goa", "south_asia_west"]),
    # ====================== GUJARAT, INDIA ============================
    _fi("dhokla (steamed gram cake)", 160, 7.0, 25.0, 3.5, 2.0, {"iron": 2.2, "folate": 0.06, "calcium": 40.0}, "prepared", ["india_gujarat", "south_asia_west"]),
    _fi("khandvi (gram flour rolls)", 140, 5.5, 18.0, 5.0, 1.0, {"iron": 1.5, "calcium": 30.0, "folate": 0.04}, "prepared", ["india_gujarat", "south_asia_west"]),
    _fi("undhiyu (mixed vegetable)", 130, 4.0, 15.0, 6.0, 4.0, {"vitamin_c": 18.0, "iron": 2.0, "potassium": 280.0, "folate": 0.05}, "prepared", ["india_gujarat", "south_asia_west"]),
    _fi("thepla (fenugreek flatbread)", 260, 6.5, 36.0, 10.0, 2.5, {"iron": 2.0, "calcium": 50.0, "zinc": 1.0}, "prepared", ["india_gujarat", "south_asia_west"]),
    _fi("khakhra (crisp flatbread)", 380, 10.0, 60.0, 10.0, 3.0, {"iron": 3.5, "phosphorus": 180.0, "zinc": 1.5}, "snack", ["india_gujarat", "south_asia_west"]),
    _fi("bajra (pearl millet)", 378, 11.6, 67.5, 5.4, 1.2, {"iron": 8.0, "magnesium": 137.0, "zinc": 3.1}, "grain", ["india_gujarat", "india_rajasthan", "south_asia_west", "south_asia_north"]),
    # ====================== RAJASTHAN, INDIA ==========================
    _fi("dal bati churma", 350, 10.0, 42.0, 15.0, 3.0, {"iron": 3.0, "calcium": 35.0, "zinc": 1.5, "phosphorus": 150.0}, "prepared", ["india_rajasthan", "south_asia_north"]),
    _fi("ker sangri (desert beans & berries)", 50, 3.0, 7.0, 0.5, 4.5, {"iron": 3.5, "calcium": 120.0, "vitamin_c": 10.0}, "vegetable", ["india_rajasthan", "south_asia_north"]),
    _fi("gatte ki sabzi (gram flour dumplings)", 180, 6.0, 18.0, 9.0, 2.0, {"iron": 2.0, "calcium": 25.0, "folate": 0.04}, "prepared", ["india_rajasthan", "south_asia_north"]),
    _fi("ghevar (disc-shaped sweet)", 380, 4.0, 52.0, 18.0, 0.5, {"calcium": 15.0, "iron": 0.5}, "snack", ["india_rajasthan", "south_asia_north"]),
    _fi("laal maas (red meat curry)", 195, 20.0, 3.0, 11.0, 0.5, {"iron": 3.0, "zinc": 5.5, "selenium": 22.0, "vitamin_b12": 0.0025}, "prepared", ["india_rajasthan", "south_asia_north"]),
    # ====================== PUNJAB, INDIA =============================
    _fi("sarson ka saag (mustard greens)", 26, 2.9, 4.7, 0.4, 3.2, {"vitamin_k": 593.0, "vitamin_a": 525.0, "vitamin_c": 70.0, "calcium": 115.0, "iron": 1.6}, "vegetable", ["india_punjab", "south_asia_north"]),
    _fi("makki ki roti (corn flatbread)", 342, 8.7, 73.0, 3.9, 7.3, {"iron": 2.7, "magnesium": 127.0, "zinc": 2.2}, "grain", ["india_punjab", "south_asia_north"]),
    _fi("lassi (yoghurt drink)", 56, 3.5, 5.0, 2.0, 0.0, {"calcium": 121.0, "phosphorus": 95.0, "riboflavin": 0.14}, "dairy", ["india_punjab", "south_asia_north"]),
    _fi("chole bhature", 390, 10.0, 46.0, 18.0, 4.0, {"iron": 3.0, "folate": 0.10, "zinc": 1.5, "potassium": 280.0}, "prepared", ["india_punjab", "south_asia_north"]),
    _fi("paneer tikka", 260, 18.0, 4.0, 19.0, 0.5, {"calcium": 480.0, "phosphorus": 350.0, "vitamin_b12": 0.001}, "prepared", ["india_punjab", "south_asia_north"]),
    _fi("dal makhani (black lentil)", 140, 7.0, 16.0, 5.5, 3.5, {"iron": 3.5, "folate": 0.08, "magnesium": 40.0, "zinc": 1.2}, "legume", ["india_punjab", "south_asia_north"]),
    _fi("amritsari kulcha (stuffed bread)", 310, 8.0, 42.0, 12.0, 2.0, {"iron": 2.0, "sodium": 550.0, "calcium": 25.0}, "prepared", ["india_punjab", "south_asia_north"]),
    # ====================== WEST BENGAL, INDIA ========================
    _fi("ilish (hilsa fish)", 273, 22.0, 0.0, 19.4, 0.0, {"omega_3": 1800.0, "vitamin_d": 25.0, "selenium": 36.5}, "fish", ["india_west_bengal", "south_asia_east"]),
    _fi("mustard oil", 884, 0.0, 0.0, 100.0, 0.0, {"omega_3": 5900.0, "vitamin_e": 11.6}, "oil", ["india_west_bengal", "south_asia_east", "south_asia_north"]),
    _fi("chingri malaikari (prawn coconut curry)", 165, 14.0, 5.0, 10.0, 0.5, {"selenium": 24.0, "zinc": 1.5, "omega_3": 280.0}, "prepared", ["india_west_bengal", "south_asia_east"]),
    _fi("kosha mangsho (slow-cooked mutton)", 210, 22.0, 3.0, 12.0, 0.5, {"iron": 3.5, "zinc": 6.0, "vitamin_b12": 0.003, "selenium": 18.0}, "prepared", ["india_west_bengal", "south_asia_east"]),
    _fi("mishti doi (sweet yoghurt)", 105, 4.0, 14.0, 3.5, 0.0, {"calcium": 130.0, "phosphorus": 100.0, "riboflavin": 0.15}, "dairy", ["india_west_bengal", "south_asia_east"]),
    _fi("sandesh (milk sweet)", 280, 8.0, 35.0, 12.0, 0.0, {"calcium": 200.0, "phosphorus": 150.0}, "snack", ["india_west_bengal", "south_asia_east"]),
    _fi("luchi (deep-fried bread)", 320, 6.0, 40.0, 15.0, 1.0, {"iron": 1.5, "sodium": 380.0}, "prepared", ["india_west_bengal", "south_asia_east"]),
    _fi("shukto (bitter vegetable stew)", 85, 2.5, 10.0, 4.0, 3.0, {"vitamin_c": 12.0, "potassium": 220.0, "calcium": 45.0}, "prepared", ["india_west_bengal", "south_asia_east"]),
    # ====================== UTTAR PRADESH, INDIA ======================
    _fi("galawati kebab", 265, 16.0, 8.0, 19.0, 0.5, {"iron": 2.5, "zinc": 4.5, "vitamin_b12": 0.002, "selenium": 15.0}, "prepared", ["india_uttar_pradesh", "south_asia_north"]),
    _fi("bedmi puri (lentil-stuffed bread)", 340, 8.0, 40.0, 16.0, 3.0, {"iron": 2.5, "folate": 0.06, "zinc": 1.0}, "prepared", ["india_uttar_pradesh", "south_asia_north"]),
    _fi("petha (ash gourd sweet)", 180, 0.3, 45.0, 0.0, 0.2, {"calcium": 5.0, "potassium": 40.0}, "snack", ["india_uttar_pradesh", "south_asia_north"]),
    _fi("tehri (turmeric rice)", 155, 3.5, 28.0, 3.0, 1.0, {"iron": 0.8, "potassium": 110.0, "vitamin_c": 5.0}, "prepared", ["india_uttar_pradesh", "south_asia_north"]),
    # ====================== GOA, INDIA ================================
    _fi("Goan fish curry (xitt kodi)", 125, 16.0, 5.0, 4.5, 0.8, {"selenium": 22.0, "omega_3": 350.0, "iron": 1.2}, "prepared", ["india_goa", "south_asia_west"]),
    _fi("pork vindaloo", 220, 18.0, 6.0, 14.0, 1.0, {"iron": 2.0, "zinc": 3.5, "selenium": 20.0, "vitamin_b12": 0.001}, "prepared", ["india_goa", "south_asia_west"]),
    _fi("bebinca (layered cake)", 310, 4.0, 38.0, 16.0, 0.5, {"calcium": 40.0, "iron": 0.8, "vitamin_a": 80.0}, "snack", ["india_goa", "south_asia_west"]),
    _fi("sannas (steamed rice cake)", 195, 3.5, 35.0, 4.5, 0.5, {"iron": 0.6, "calcium": 12.0}, "prepared", ["india_goa", "south_asia_west"]),
    _fi("prawn balchão (pickle)", 155, 14.0, 6.0, 8.0, 0.5, {"selenium": 25.0, "sodium": 1200.0, "iron": 1.5}, "prepared", ["india_goa", "south_asia_west"]),
    # ====================== ODISHA, INDIA =============================
    _fi("pakhala bhata (fermented rice)", 120, 2.5, 25.0, 0.5, 0.8, {"iron": 0.6, "probiotics": 1.0, "vitamin_b12": 0.0005}, "prepared", ["india_odisha", "south_asia_east"]),
    _fi("dalma (lentil vegetable stew)", 95, 5.0, 13.0, 2.0, 3.0, {"iron": 1.8, "folate": 0.06, "potassium": 250.0, "vitamin_c": 8.0}, "prepared", ["india_odisha", "south_asia_east"]),
    _fi("chhena poda (baked cheese dessert)", 280, 9.0, 32.0, 13.0, 0.0, {"calcium": 180.0, "phosphorus": 140.0}, "snack", ["india_odisha", "south_asia_east"]),
    _fi("machha besara (fish in mustard)", 145, 18.0, 2.0, 7.0, 0.5, {"omega_3": 600.0, "selenium": 28.0, "iron": 1.5}, "prepared", ["india_odisha", "south_asia_east"]),
    # ====================== SICHUAN, CHINA ============================
    _fi("sichuan peppercorn", 0, 0.0, 0.0, 0.0, 0.0, {"polyphenols": 450.0}, "spice", ["china_sichuan", "east_asia"]),
    _fi("doubanjiang (fermented bean paste)", 63, 4.0, 9.0, 1.5, 2.0, {"iron": 3.5, "sodium": 4800.0}, "prepared", ["china_sichuan", "east_asia"]),
    _fi("mapo tofu", 90, 6.5, 4.0, 5.5, 0.5, {"calcium": 130.0, "iron": 2.5, "selenium": 7.0, "manganese": 0.5}, "prepared", ["china_sichuan", "east_asia"]),
    _fi("dan dan noodles", 195, 8.0, 24.0, 7.5, 1.5, {"iron": 1.8, "selenium": 10.0, "sodium": 680.0}, "prepared", ["china_sichuan", "east_asia"]),
    _fi("kung pao chicken", 170, 16.0, 8.0, 8.5, 1.5, {"selenium": 18.0, "zinc": 1.8, "vitamin_b6": 0.4, "iron": 1.2}, "prepared", ["china_sichuan", "east_asia"]),
    _fi("twice-cooked pork (hui guo rou)", 245, 12.0, 5.0, 20.0, 0.5, {"zinc": 2.5, "selenium": 22.0, "vitamin_b1": 0.5, "iron": 1.0}, "prepared", ["china_sichuan", "east_asia"]),
    _fi("water-boiled fish (shui zhu yu)", 135, 18.0, 2.0, 6.5, 0.5, {"omega_3": 350.0, "selenium": 24.0, "vitamin_d": 5.0}, "prepared", ["china_sichuan", "east_asia"]),
    _fi("sichuan pickled vegetables", 18, 0.8, 3.5, 0.1, 1.5, {"vitamin_c": 15.0, "probiotics": 1.0, "sodium": 1200.0}, "vegetable", ["china_sichuan", "east_asia"]),
    # ====================== CANTONESE, CHINA ==========================
    _fi("dim sum (shrimp dumpling, har gow)", 210, 10.0, 22.0, 8.0, 0.5, {"selenium": 20.0, "iron": 1.2}, "prepared", ["china_cantonese", "east_asia"]),
    _fi("congee (rice porridge)", 46, 1.1, 10.0, 0.1, 0.2, {"iron": 0.2, "manganese": 0.15}, "grain", ["china_cantonese", "east_asia", "southeast_asia"]),
    _fi("char siu (BBQ pork)", 220, 18.0, 12.0, 11.0, 0.0, {"zinc": 3.0, "selenium": 25.0, "iron": 1.5, "vitamin_b1": 0.4}, "prepared", ["china_cantonese", "east_asia"]),
    _fi("wonton noodle soup", 165, 10.0, 20.0, 5.0, 0.8, {"iron": 1.5, "selenium": 12.0, "sodium": 780.0}, "prepared", ["china_cantonese", "east_asia"]),
    _fi("steamed whole fish (Cantonese)", 110, 20.0, 2.0, 2.5, 0.0, {"omega_3": 800.0, "selenium": 35.0, "vitamin_d": 8.0, "phosphorus": 200.0}, "prepared", ["china_cantonese", "east_asia"]),
    _fi("cheung fun (rice noodle rolls)", 120, 3.0, 22.0, 2.0, 0.3, {"iron": 0.5, "manganese": 0.2}, "prepared", ["china_cantonese", "east_asia"]),
    _fi("clay pot rice (bao zai fan)", 190, 10.0, 28.0, 4.0, 0.5, {"iron": 1.5, "zinc": 1.8, "selenium": 12.0}, "prepared", ["china_cantonese", "east_asia"]),
    _fi("gai lan (Chinese broccoli)", 26, 1.2, 4.7, 0.6, 2.2, {"vitamin_c": 28.0, "vitamin_a": 88.0, "calcium": 88.0, "iron": 0.6}, "vegetable", ["china_cantonese", "east_asia"]),
    # ====================== SHANDONG, CHINA ===========================
    _fi("braised sea cucumber", 56, 12.0, 0.6, 0.3, 0.0, {"collagen": 250.0, "selenium": 18.0, "zinc": 1.0, "iron": 0.8}, "seafood", ["china_shandong", "east_asia"]),
    _fi("sweet and sour Yellow River carp", 150, 16.0, 10.0, 5.0, 0.3, {"omega_3": 400.0, "selenium": 22.0, "phosphorus": 180.0}, "prepared", ["china_shandong", "east_asia"]),
    _fi("jiaozi (boiled dumplings)", 185, 8.5, 25.0, 5.5, 1.0, {"iron": 1.5, "selenium": 10.0, "zinc": 1.2}, "prepared", ["china_shandong", "east_asia"]),
    _fi("mantou (steamed bun)", 231, 7.0, 47.0, 1.0, 1.5, {"iron": 1.5, "thiamine": 0.1, "selenium": 8.0}, "grain", ["china_shandong", "east_asia"]),
    _fi("scallion pancake (cong you bing)", 260, 5.0, 32.0, 12.0, 1.0, {"iron": 1.0, "selenium": 6.0, "sodium": 450.0}, "prepared", ["china_shandong", "east_asia"]),
    _fi("Yantai apple", 52, 0.3, 13.8, 0.2, 2.4, {"vitamin_c": 4.6, "potassium": 107.0, "quercetin": 4.0}, "fruit", ["china_shandong", "east_asia"]),
    # ====================== JIANGSU/SHANGHAI, CHINA ===================
    _fi("xiaolongbao (soup dumpling)", 220, 9.0, 22.0, 10.5, 0.5, {"iron": 1.5, "zinc": 1.8, "selenium": 12.0}, "prepared", ["china_jiangsu", "east_asia"]),
    _fi("red-braised pork belly (hong shao rou)", 340, 14.0, 8.0, 28.0, 0.0, {"zinc": 3.5, "selenium": 28.0, "iron": 1.2, "vitamin_b1": 0.4}, "prepared", ["china_jiangsu", "east_asia"]),
    _fi("lion's head meatball", 200, 12.0, 6.0, 14.0, 0.5, {"iron": 1.8, "zinc": 2.5, "selenium": 18.0}, "prepared", ["china_jiangsu", "east_asia"]),
    _fi("hairy crab (Shanghai)", 102, 15.5, 2.4, 3.3, 0.0, {"selenium": 35.0, "zinc": 5.0, "omega_3": 300.0, "vitamin_b12": 0.008}, "seafood", ["china_jiangsu", "east_asia"]),
    _fi("Nanjing salted duck", 195, 20.0, 0.0, 12.0, 0.0, {"zinc": 2.5, "selenium": 22.0, "iron": 2.0, "sodium": 850.0}, "prepared", ["china_jiangsu", "east_asia"]),
    _fi("shepherd's purse (ji cai)", 33, 2.5, 5.5, 0.4, 2.0, {"vitamin_c": 44.0, "vitamin_a": 150.0, "calcium": 150.0, "iron": 2.0}, "vegetable", ["china_jiangsu", "east_asia"]),
    # ====================== HUNAN, CHINA ==============================
    _fi("Chairman Mao's braised pork", 360, 14.0, 10.0, 30.0, 0.0, {"zinc": 3.5, "iron": 1.5, "selenium": 25.0, "vitamin_b1": 0.5}, "prepared", ["china_hunan", "east_asia"]),
    _fi("steamed fish head with chopped chili", 110, 16.0, 3.0, 4.0, 0.5, {"omega_3": 500.0, "selenium": 30.0, "vitamin_d": 6.0}, "prepared", ["china_hunan", "east_asia"]),
    _fi("Changsha stinky tofu", 180, 10.0, 12.0, 10.0, 1.5, {"calcium": 200.0, "iron": 3.0, "probiotics": 1.0}, "prepared", ["china_hunan", "east_asia"]),
    _fi("Hunan smoked pork (la rou)", 330, 15.0, 1.0, 29.0, 0.0, {"zinc": 3.0, "selenium": 20.0, "iron": 1.5, "sodium": 1500.0}, "prepared", ["china_hunan", "east_asia"]),
    _fi("Hunan rice noodles (mi fen)", 110, 2.0, 24.0, 0.5, 0.5, {"iron": 0.5, "selenium": 4.0, "manganese": 0.3}, "grain", ["china_hunan", "east_asia"]),
    # ====================== US SOUTH ==================================
    _fi("collard greens (cooked)", 33, 2.7, 5.4, 0.4, 3.6, {"vitamin_k": 407.0, "vitamin_a": 380.0, "calcium": 141.0, "folate": 44.0, "vitamin_c": 18.2}, "vegetable", ["usa_south", "north_america"]),
    _fi("grits (corn)", 65, 1.5, 14.0, 0.2, 0.2, {"iron": 0.7, "thiamine": 0.08}, "grain", ["usa_south", "north_america"]),
    _fi("fried catfish", 229, 18.0, 8.0, 13.0, 0.5, {"selenium": 12.0, "omega_3": 300.0, "phosphorus": 190.0}, "fish", ["usa_south", "north_america"]),
    _fi("gumbo (seafood)", 85, 6.5, 7.0, 3.5, 1.2, {"vitamin_c": 8.0, "iron": 1.5, "selenium": 10.0, "zinc": 1.0}, "prepared", ["usa_south", "north_america"]),
    _fi("jambalaya", 130, 9.0, 14.0, 4.0, 1.0, {"iron": 1.5, "selenium": 12.0, "zinc": 1.2, "vitamin_c": 6.0}, "prepared", ["usa_south", "north_america"]),
    _fi("cornbread", 196, 4.0, 31.0, 6.0, 1.5, {"iron": 1.5, "thiamine": 0.12, "phosphorus": 85.0}, "grain", ["usa_south", "north_america"]),
    _fi("sweet potato pie", 165, 2.0, 28.0, 5.5, 1.5, {"vitamin_a": 560.0, "vitamin_c": 5.0, "potassium": 150.0}, "prepared", ["usa_south", "north_america"]),
    _fi("black-eyed peas (cooked)", 116, 7.7, 20.8, 0.5, 6.5, {"folate": 210.0, "iron": 2.5, "potassium": 278.0, "magnesium": 53.0, "zinc": 1.3}, "legume", ["usa_south", "north_america"]),
    _fi("pulled pork BBQ", 210, 22.0, 5.0, 11.0, 0.0, {"zinc": 4.0, "selenium": 28.0, "vitamin_b12": 0.001, "iron": 1.5}, "prepared", ["usa_south", "north_america"]),
    # ====================== US NORTHEAST ==============================
    _fi("New England clam chowder", 95, 5.0, 10.0, 3.5, 0.5, {"vitamin_b12": 0.015, "selenium": 15.0, "iron": 2.5, "zinc": 1.2}, "prepared", ["usa_northeast", "north_america"]),
    _fi("lobster (steamed)", 89, 19.0, 0.0, 0.9, 0.0, {"selenium": 41.4, "zinc": 3.5, "copper": 1.9, "vitamin_b12": 0.001, "omega_3": 200.0}, "seafood", ["usa_northeast", "north_america"]),
    _fi("bagel (plain)", 270, 10.0, 53.0, 1.5, 2.0, {"iron": 3.0, "thiamine": 0.4, "folate": 100.0, "selenium": 22.0}, "grain", ["usa_northeast", "north_america"]),
    _fi("New York-style pizza (slice)", 266, 11.0, 33.0, 10.0, 2.0, {"calcium": 180.0, "sodium": 640.0, "selenium": 18.0, "iron": 2.0}, "prepared", ["usa_northeast", "north_america"]),
    _fi("pastrami", 147, 22.0, 1.5, 5.5, 0.0, {"zinc": 5.0, "iron": 2.5, "vitamin_b12": 0.002, "selenium": 22.0, "sodium": 885.0}, "prepared", ["usa_northeast", "north_america"]),
    _fi("cranberry", 46, 0.4, 12.2, 0.1, 4.6, {"vitamin_c": 13.3, "manganese": 0.36, "vitamin_e": 1.2, "proanthocyanidins": 230.0}, "fruit", ["usa_northeast", "north_america"]),
    # ====================== US MIDWEST ================================
    _fi("walleye (baked)", 105, 21.5, 0.0, 1.3, 0.0, {"selenium": 12.6, "omega_3": 340.0, "phosphorus": 220.0, "vitamin_d": 5.0}, "fish", ["usa_midwest", "north_america"]),
    _fi("bratwurst", 295, 12.0, 2.5, 26.0, 0.0, {"zinc": 3.5, "selenium": 16.0, "vitamin_b12": 0.001, "iron": 1.2}, "prepared", ["usa_midwest", "north_america"]),
    _fi("wild rice", 101, 4.0, 21.3, 0.3, 1.8, {"magnesium": 52.0, "phosphorus": 82.0, "zinc": 1.3, "manganese": 0.3, "folate": 26.0}, "grain", ["usa_midwest", "north_america"]),
    _fi("cheese curds (fresh)", 350, 24.0, 2.0, 27.0, 0.0, {"calcium": 700.0, "phosphorus": 510.0, "vitamin_b12": 0.002, "zinc": 3.5}, "dairy", ["usa_midwest", "north_america"]),
    _fi("hotdish (tater tot casserole)", 150, 8.0, 14.0, 7.0, 1.0, {"iron": 1.2, "calcium": 50.0, "sodium": 480.0}, "prepared", ["usa_midwest", "north_america"]),
    # ====================== US WEST ===================================
    _fi("wild salmon (Pacific)", 182, 25.4, 0.0, 8.1, 0.0, {"omega_3": 2150.0, "vitamin_d": 11.0, "selenium": 31.0, "astaxanthin": 3.5}, "fish", ["usa_west", "north_america"]),
    _fi("avocado", 160, 2.0, 8.5, 14.7, 6.7, {"potassium": 485.0, "folate": 81.0, "vitamin_e": 2.07, "vitamin_k": 21.0, "magnesium": 29.0}, "fruit", ["usa_west", "usa_southwest", "north_america", "latin_america", "central_america"]),
    _fi("sourdough bread", 266, 8.5, 51.0, 3.0, 2.0, {"selenium": 22.0, "iron": 2.5, "thiamine": 0.3, "folate": 80.0}, "grain", ["usa_west", "north_america"]),
    _fi("Dungeness crab", 86, 17.4, 0.0, 1.0, 0.0, {"selenium": 40.0, "zinc": 6.5, "copper": 0.7, "omega_3": 380.0, "vitamin_b12": 0.009}, "seafood", ["usa_west", "north_america"]),
    _fi("acai bowl", 70, 1.0, 6.0, 5.0, 3.5, {"anthocyanins": 320.0, "vitamin_c": 8.0, "omega_3": 40.0}, "fruit", ["usa_west", "north_america", "brazil_northeast", "brazil_southeast"]),
    _fi("kale salad", 35, 2.9, 4.4, 0.6, 4.1, {"vitamin_k": 390.0, "vitamin_c": 93.0, "vitamin_a": 241.0, "calcium": 254.0, "manganese": 0.9}, "vegetable", ["usa_west", "north_america"]),
    # ====================== US SOUTHWEST ==============================
    _fi("green chile (Hatch, roasted)", 40, 2.0, 8.0, 0.2, 1.5, {"vitamin_c": 109.0, "vitamin_a": 59.0, "capsaicin": 1.5, "potassium": 340.0}, "vegetable", ["usa_southwest", "north_america"]),
    _fi("pinto beans (cooked)", 143, 9.0, 26.2, 0.6, 9.0, {"folate": 172.0, "iron": 2.1, "magnesium": 50.0, "potassium": 436.0, "zinc": 0.9}, "legume", ["usa_southwest", "north_america", "mexico_central", "latin_america"]),
    _fi("nopal (prickly pear cactus pad)", 16, 1.3, 3.3, 0.1, 2.2, {"vitamin_c": 9.3, "calcium": 164.0, "magnesium": 52.0, "potassium": 257.0}, "vegetable", ["usa_southwest", "mexico_central", "north_america", "latin_america"]),
    _fi("tamale (pork)", 210, 8.0, 20.0, 11.0, 2.5, {"iron": 2.0, "calcium": 60.0, "zinc": 1.5, "selenium": 10.0}, "prepared", ["usa_southwest", "mexico_central", "north_america"]),
    _fi("sopapilla", 300, 5.0, 36.0, 15.0, 1.0, {"iron": 1.5, "calcium": 20.0, "sodium": 280.0}, "prepared", ["usa_southwest", "north_america"]),
    _fi("carne asada (grilled beef)", 205, 26.0, 0.0, 10.5, 0.0, {"zinc": 6.5, "iron": 2.8, "selenium": 28.0, "vitamin_b12": 0.003}, "prepared", ["usa_southwest", "mexico_central", "north_america"]),
    # ====================== OKINAWA, JAPAN (Blue Zone) ================
    _fi("goya (bitter melon, Okinawan)", 17, 1.0, 3.7, 0.2, 2.6, {"vitamin_c": 84.0, "folate": 72.0, "potassium": 296.0}, "vegetable", ["japan_okinawa", "east_asia"]),
    _fi("beni-imo (Okinawan purple sweet potato)", 118, 1.6, 27.9, 0.1, 3.0, {"anthocyanins": 250.0, "vitamin_c": 22.0, "potassium": 337.0}, "vegetable", ["japan_okinawa", "east_asia"]),
    _fi("tofu (Okinawan firm)", 76, 8.1, 1.9, 4.8, 0.3, {"calcium": 350.0, "iron": 5.4, "magnesium": 30.0, "selenium": 7.0}, "legume", ["japan_okinawa", "east_asia"]),
    _fi("mozuku seaweed", 6, 0.3, 1.4, 0.1, 1.0, {"fucoidan": 80.0, "iodine": 0.15}, "vegetable", ["japan_okinawa", "east_asia"]),
    _fi("shikuwasa (citrus)", 35, 0.5, 8.2, 0.2, 1.0, {"nobiletin": 15.0, "vitamin_c": 36.0}, "fruit", ["japan_okinawa", "east_asia"]),
    _fi("goya chanpuru (bitter melon stir-fry)", 80, 7.0, 4.0, 4.5, 1.5, {"vitamin_c": 55.0, "calcium": 40.0, "iron": 1.2, "folate": 30.0}, "prepared", ["japan_okinawa", "east_asia"]),
    _fi("rafute (Okinawan braised pork belly)", 250, 15.0, 5.0, 19.0, 0.0, {"zinc": 3.0, "selenium": 22.0, "collagen": 150.0, "vitamin_b1": 0.4}, "prepared", ["japan_okinawa", "east_asia"]),
    _fi("Okinawan soba", 130, 5.5, 24.0, 1.0, 1.2, {"iron": 1.0, "manganese": 0.3, "selenium": 6.0}, "prepared", ["japan_okinawa", "east_asia"]),
    _fi("jimami tofu (peanut tofu)", 145, 5.0, 8.0, 10.0, 1.0, {"magnesium": 25.0, "vitamin_e": 2.5, "niacin": 3.0}, "prepared", ["japan_okinawa", "east_asia"]),
    _fi("awamori (Okinawan spirit)", 206, 0.0, 0.0, 0.0, 0.0, {}, "beverage", ["japan_okinawa", "east_asia"]),
    _fi("kombu seaweed (dried)", 43, 1.7, 9.6, 0.1, 1.3, {"iodine": 2.5, "fucoidan": 60.0, "calcium": 168.0, "iron": 2.8, "magnesium": 121.0}, "vegetable", ["japan_okinawa", "east_asia"]),
    # ====================== CENTRAL MEXICO ============================
    _fi("mole poblano (sauce)", 160, 5.0, 16.0, 9.0, 3.0, {"iron": 2.5, "magnesium": 55.0, "theobromine": 30.0, "vitamin_a": 120.0}, "prepared", ["mexico_central", "latin_america", "central_america"]),
    _fi("tacos al pastor", 215, 12.0, 18.0, 10.0, 1.5, {"iron": 2.0, "zinc": 2.5, "selenium": 15.0, "vitamin_c": 8.0}, "prepared", ["mexico_central", "latin_america"]),
    _fi("huitlacoche (corn truffle)", 35, 3.5, 3.4, 0.7, 2.0, {"lysine": 250.0, "iron": 2.0, "phosphorus": 110.0, "niacin": 2.0}, "vegetable", ["mexico_central", "latin_america"]),
    _fi("chiles en nogada", 180, 8.0, 12.0, 11.0, 2.0, {"vitamin_c": 18.0, "vitamin_a": 95.0, "iron": 1.5, "zinc": 1.5}, "prepared", ["mexico_central", "latin_america"]),
    _fi("pozole (hominy stew)", 100, 7.0, 12.0, 2.5, 2.0, {"iron": 1.5, "niacin": 1.5, "potassium": 180.0, "zinc": 1.0}, "prepared", ["mexico_central", "latin_america"]),
    _fi("chapulines (roasted grasshoppers)", 350, 60.0, 5.0, 10.0, 5.0, {"iron": 8.0, "zinc": 10.0, "calcium": 75.0}, "prepared", ["mexico_central", "latin_america"]),
    _fi("nixtamalized corn tortilla", 218, 5.7, 44.6, 2.9, 3.0, {"calcium": 114.0, "iron": 1.5, "niacin": 1.4, "magnesium": 33.0}, "grain", ["mexico_central", "usa_southwest", "latin_america", "central_america"]),
    _fi("atole (corn drink)", 90, 1.5, 18.0, 1.5, 0.5, {"calcium": 30.0, "iron": 0.5, "vitamin_c": 3.0}, "beverage", ["mexico_central", "central_america"]),
    _fi("epazote (herb)", 32, 0.3, 7.4, 0.5, 3.8, {"vitamin_a": 85.0, "vitamin_c": 3.6, "iron": 1.9, "manganese": 0.9}, "spice", ["mexico_central", "latin_america", "central_america"]),
    # ====================== NORTHEAST BRAZIL ==========================
    _fi("acarajé (black-eyed pea fritter)", 290, 10.0, 22.0, 18.0, 3.0, {"iron": 3.0, "folate": 120.0, "zinc": 1.5, "potassium": 280.0}, "prepared", ["brazil_northeast", "south_america"]),
    _fi("vatapá (shrimp paste)", 195, 8.0, 12.0, 13.0, 1.5, {"selenium": 18.0, "iron": 2.0, "vitamin_e": 3.0, "omega_3": 200.0}, "prepared", ["brazil_northeast", "south_america"]),
    _fi("moqueca baiana (fish stew)", 135, 14.0, 5.0, 7.0, 1.0, {"selenium": 25.0, "omega_3": 450.0, "iron": 1.5, "vitamin_c": 10.0}, "prepared", ["brazil_northeast", "south_america"]),
    _fi("carne de sol (sun-dried beef)", 230, 38.0, 0.0, 8.0, 0.0, {"iron": 3.5, "zinc": 7.0, "vitamin_b12": 0.004, "sodium": 2000.0}, "meat", ["brazil_northeast", "south_america"]),
    _fi("dendê oil (red palm oil)", 862, 0.0, 0.0, 100.0, 0.0, {"vitamin_a": 5000.0, "vitamin_e": 15.9, "coenzyme_q10": 5.4}, "oil", ["brazil_northeast", "south_america", "west_africa"]),
    _fi("acerola cherry", 32, 0.4, 7.7, 0.3, 1.1, {"vitamin_c": 1677.0, "vitamin_a": 38.0, "potassium": 146.0}, "fruit", ["brazil_northeast", "brazil_southeast", "south_america"]),
    _fi("tapioca crepe (beiju)", 130, 0.3, 32.0, 0.1, 0.5, {"iron": 0.3, "calcium": 8.0, "manganese": 0.1}, "prepared", ["brazil_northeast", "south_america"]),
    _fi("cashew fruit (caju)", 43, 0.9, 9.1, 0.4, 0.5, {"vitamin_c": 219.0, "iron": 0.2, "potassium": 124.0, "magnesium": 16.0}, "fruit", ["brazil_northeast", "south_america"]),
    # ====================== SOUTHEAST BRAZIL ==========================
    _fi("feijoada (black bean stew)", 155, 10.0, 12.0, 7.5, 5.0, {"iron": 3.0, "folate": 80.0, "zinc": 2.0, "potassium": 310.0}, "prepared", ["brazil_southeast", "south_america"]),
    _fi("pão de queijo (cheese bread)", 360, 6.0, 42.0, 18.0, 0.5, {"calcium": 120.0, "phosphorus": 85.0, "iron": 0.5}, "prepared", ["brazil_southeast", "south_america"]),
    _fi("picanha (top sirloin cap)", 215, 26.0, 0.0, 12.0, 0.0, {"zinc": 6.0, "iron": 2.5, "selenium": 26.0, "vitamin_b12": 0.003}, "meat", ["brazil_southeast", "south_america"]),
    _fi("farofa (toasted cassava flour)", 365, 1.5, 80.0, 2.0, 2.0, {"iron": 1.0, "manganese": 0.3, "magnesium": 20.0}, "grain", ["brazil_southeast", "brazil_northeast", "south_america"]),
    _fi("coxinha (chicken croquette)", 280, 10.0, 25.0, 15.0, 1.0, {"iron": 1.2, "selenium": 12.0, "sodium": 550.0}, "prepared", ["brazil_southeast", "south_america"]),
    _fi("brigadeiro (chocolate truffle)", 370, 5.0, 52.0, 16.0, 1.0, {"calcium": 100.0, "phosphorus": 80.0, "theobromine": 20.0}, "snack", ["brazil_southeast", "south_america"]),
    _fi("couve mineira (sautéed kale)", 45, 3.0, 5.0, 2.0, 3.0, {"vitamin_k": 350.0, "vitamin_c": 80.0, "calcium": 135.0, "iron": 1.5}, "vegetable", ["brazil_southeast", "south_america"]),
    # ====================== SOUTHERN ITALY ============================
    _fi("mozzarella di bufala", 280, 22.0, 0.5, 21.0, 0.0, {"calcium": 505.0, "phosphorus": 354.0, "vitamin_b12": 0.001, "zinc": 2.5}, "dairy", ["italy_south", "mediterranean"]),
    _fi("San Marzano tomato", 18, 0.9, 3.9, 0.2, 1.2, {"vitamin_c": 14.0, "lycopene": 4.5, "potassium": 237.0, "vitamin_a": 42.0}, "vegetable", ["italy_south", "mediterranean"]),
    _fi("orecchiette con cime di rapa", 175, 6.5, 28.0, 4.5, 2.5, {"vitamin_k": 120.0, "iron": 1.8, "vitamin_c": 12.0, "calcium": 80.0}, "prepared", ["italy_south", "mediterranean"]),
    _fi("Amalfi lemon", 29, 1.1, 9.3, 0.3, 2.8, {"vitamin_c": 53.0, "potassium": 138.0, "folate": 11.0, "limonene": 5.0}, "fruit", ["italy_south", "mediterranean"]),
    _fi("swordfish (Mediterranean)", 144, 23.5, 0.0, 4.9, 0.0, {"selenium": 52.0, "omega_3": 640.0, "vitamin_d": 14.0, "vitamin_b12": 0.002}, "fish", ["italy_south", "mediterranean"]),
    _fi("eggplant parmigiana", 130, 6.0, 10.0, 8.0, 3.0, {"calcium": 120.0, "vitamin_c": 4.0, "iron": 0.8, "potassium": 180.0}, "prepared", ["italy_south", "mediterranean"]),
    _fi("sfogliatella", 380, 6.0, 42.0, 20.0, 1.0, {"calcium": 25.0, "iron": 1.5, "sodium": 250.0}, "snack", ["italy_south", "mediterranean"]),
    _fi("anchovies (Cetara, preserved)", 131, 20.4, 0.0, 4.8, 0.0, {"omega_3": 1478.0, "calcium": 147.0, "selenium": 36.5, "vitamin_d": 11.0, "iron": 3.3}, "fish", ["italy_south", "mediterranean"]),
    # ====================== NORTHERN ITALY ============================
    _fi("risotto alla milanese", 160, 4.5, 28.0, 3.5, 0.5, {"iron": 0.8, "selenium": 6.0, "calcium": 15.0}, "prepared", ["italy_north", "mediterranean", "western_europe"]),
    _fi("polenta (cooked)", 70, 1.6, 15.0, 0.3, 0.5, {"iron": 0.4, "magnesium": 8.0, "manganese": 0.06, "thiamine": 0.02}, "grain", ["italy_north", "mediterranean", "western_europe"]),
    _fi("parmigiano-reggiano", 392, 33.0, 3.2, 27.3, 0.0, {"calcium": 1180.0, "phosphorus": 694.0, "vitamin_b12": 0.003, "zinc": 4.2, "selenium": 22.5}, "dairy", ["italy_north", "mediterranean", "western_europe"]),
    _fi("tortellini in brodo", 215, 10.0, 26.0, 7.5, 1.0, {"iron": 1.8, "zinc": 2.0, "selenium": 14.0, "sodium": 550.0}, "prepared", ["italy_north", "mediterranean"]),
    _fi("ossobuco (braised veal shank)", 190, 22.0, 3.0, 10.0, 0.0, {"zinc": 5.5, "iron": 2.5, "selenium": 18.0, "collagen": 200.0, "vitamin_b12": 0.002}, "prepared", ["italy_north", "mediterranean"]),
    _fi("pesto alla genovese", 300, 4.0, 3.0, 30.0, 1.5, {"vitamin_k": 60.0, "vitamin_e": 4.0, "calcium": 120.0, "iron": 1.5, "magnesium": 35.0}, "prepared", ["italy_north", "mediterranean"]),
    _fi("white truffle (Alba)", 36, 6.0, 0.7, 0.5, 5.0, {"selenium": 2.0, "iron": 3.5, "phosphorus": 100.0}, "vegetable", ["italy_north", "mediterranean"]),
    _fi("balsamic vinegar (Modena)", 88, 0.5, 17.0, 0.0, 0.0, {"polyphenols": 600.0, "potassium": 112.0, "iron": 0.7}, "spice", ["italy_north", "mediterranean"]),
]
